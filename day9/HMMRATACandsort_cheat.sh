...
#SBATCH --output=/scratch/Users/username/e_and_o/HMMRATAC.%j.out # Standard output
#SBATCH --error=/scratch/Users/username/e_and_o/HMMRATAC.%j.err # Standard error log
