...
cat boxes/heart_shaped_box.txt boxes/star_shaped_box.txt > boxes/combined_box.txt
...
grep polka_dot boxes/combined_box.txt > boxes/polka_dot.txt
...
grep polka_dot boxes/combined_box.txt | wc -l > boxes/polka_dot_number.txt
...
grep chr1 genes/human_genes.txt > genes/out/human_chr1_exons.txt
...
grep chr1 genes/mouse_genes.txt | wc -l > genes/out/mouse_chr1_exon_count.txt
...
grep chr1 genes/mouse_genes.txt | grep exon1 | wc -l > genes/out/mouse_chr1_gene_count.txt
grep chr1 genes/human_genes.txt | grep exon1 | wc -l > genes/out/human_chr1_gene_count.txt
# A : No. Mouse (1), Human (2)
...
# column)
grep sonic_hedgehog genes/mouse_genes.txt | tail -n 1 | awk '{ print $3 }' > genes/out/mouse_sonic_hedgehog_last_exon.txt
grep sonic_hedgehog genes/human_genes.txt | tail -n 1 | awk '{ print $3 }' > genes/out/human_sonic_hedgehog_last_exon.txt
...
grep -v "#" genes/worm_genes.txt > genes/out/worm_genes_no_comments.txt
...
# made.
awk '$1="chr"$1' genes/out/worm_genes_no_comments.txt > genes/out/worm_genes_fixed.txt
...
sort -k1,1 -nk2,2 genes/out/worm_genes_fixed.txt > genes/out/worm_genes_final.txt
